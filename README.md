...
2. Install the required dependencies:
   ```
   pip install PyQt5 requests qtconsole fuzzywuzzy google-genai chromadb langchain langchain-community sentence-transformers pymupdf numpy torch pickle docx sklearn scipy
   ```
